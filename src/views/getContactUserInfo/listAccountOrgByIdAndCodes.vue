<template>
  <div class="listAccountOrgByIdAndCodes">
    <div class="flex a-center">
      <van-field v-model="accountId" label="账号 id" placeholder="请输入账号 id" />
      <div style="text-align: center;width: 100px;padding: 0 10px;"/>
    </div>
    <div class="flex a-center">
      <van-field v-model="organizationCodes" label="组织 Code 列表" placeholder="请输入组织 Code 列表" />
      <div style="text-align: center;width: 99%;padding: 0 10px;">注：最多 100 个</div>
    </div>
    <div class="nt-btn login-btn" style="line-height: 40px;"  @click='registerEventCallback'>查询账号是否在此租户的组织内</div>
...
export default{
  ...
  methods: {
    registerEventCallback() {
      this.$get('/get-contact-user-info/list-account-org-by-id-and-codes',{
