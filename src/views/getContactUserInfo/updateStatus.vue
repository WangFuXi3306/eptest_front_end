<template>
  <div class="updateStatus ">
    <div class="flex a-center">
      <van-field v-model="propertyCode" label="属性 code" placeholder="请输入属性 code" />
    ...
    <div class="flex a-center">
      <van-field v-model="namespace" label="帐号类型" placeholder="请输入帐号类型" />
      <div style="text-align: center;width: 100px;padding: 0 10px;"/>
    </div>
    <div class="nt-btn login-btn" style="line-height: 40px;"  @click='getByEmployeeCode1'>冻结和解冻账号</div>
...
export default{
  ...
  methods: {
    getByEmployeeCode1() {
      this.$get('/get-contact-user-info/update-status',{
