<template>
  <div class="getEmployeeTags">
    ...
    <div class="nt-btn login-btn" style="line-height: 40px;"  @click='getByEmployeeCode1'>根据员工 Code 查询详情</div>
    <div class="nt-btn login-btn" style="line-height: 40px;"  @click='getByEmployeeCode2'>根据员工 Code 获取员工标签 code 列表</div>
...
export default{
  ...
  methods: {
    getByEmployeeCode1() {
      this.$get('/get-contact-user-info/get-by-employee-code',{
    ...
    getByEmployeeCode2() {
      this.$get('/get-contact-user-info/get-employee-tags',{
        employeeCode:this.employeeCode,
      }).then(res => {
        this.callbackMsg = JSON.stringify(res);
      })
